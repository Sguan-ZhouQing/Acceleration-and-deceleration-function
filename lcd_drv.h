/*
 * @Author: 星必尘Sguan
 * @Date: 2025-11-04 19:28:52
 * @LastEditors: 星必尘Sguan|3464647102@qq.com
 * @LastEditTime: 2025-11-08 15:33:12
 * @FilePath: \demo_SguanFOCv2.0\Hardware\lcd_drv.h
 * @Description: 
 * 
...
#define LCD_RES_Clr()  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11,GPIO_PIN_RESET)//RES
#define LCD_RES_Set()  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11,GPIO_PIN_SET)
...
// 新填函数声明
void LCD_Write_Buffer(uint8_t *data, uint16_t length);
void LCD_Fill_Fast(uint16_t xsta, uint16_t ysta, uint16_t xend, uint16_t yend, uint16_t color);
void LCD_Wait_DMA_Complete(void);
