 ...
 * @LastEditTime: 2025-11-07 21:19:40
...
void Set_Duty(float d_u,float d_v,float d_w) {
    ...
    Compare_u = (uint16_t)(4250*d_u);
    Compare_v = (uint16_t)(4250*d_v);
    Compare_w = (uint16_t)(4250*d_w);
    if (Motor_Dir) {
...
void Speed_PidInit(void) {
    SguanVal.Kp = 0.02244f;
    SguanVal.Ki = 0.00011122f;
    SguanVal.Kd = 0.0f;
    SguanVal.OutMax = 0.8f;
    SguanVal.OutMin = -0.8f;
}
